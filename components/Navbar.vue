...
<nav class="border-b">
    <div x-data="{showMenu : false}" class="container max-w-screen-lg mx-auto flex justify-between h-14">
        ...
        <a href="#" class="flex items-center cursor-pointer hover:bg-purple-50 px-2 ml-3">
            ...
            <div class="text-gray-700 font-semibold ml-2">Alphabet Tech</div>
        </a>
        <!-- Navbar Toggle Button -->
        <button  class="block md:hidden text-gray-700 p-2 rounded hover:border focus:border focus:bg-gray-100 my-2 mr-5" type="button" aria-controls="navbar-main" aria-expanded="false" aria-label="Toggle navigation">
